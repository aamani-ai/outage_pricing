...
*Audience: senior team. Last reviewed: 2026-06-03. Reads naturally after [`eagle_i_data_fundamentals.md`](eagle_i_data_fundamentals.md).*
...
- **mean_customers_out** — average across all 15-min snapshots inside the event. Feeds the per-customer multiplier (see [`per_customer_pricing_fundamentals.md`](per_customer_pricing_fundamentals.md)).
...
These two quantities are the inputs to the county-trigger pricing formula (see [`county_trigger_pricing_fundamentals.md`](county_trigger_pricing_fundamentals.md)). The event catalog is also where `mean_customers_out` lives — the field that drives the per-customer multiplier.
...
- Downstream consumer: [`county_trigger_pricing_fundamentals.md`](county_trigger_pricing_fundamentals.md), [`per_customer_pricing_fundamentals.md`](per_customer_pricing_fundamentals.md)
