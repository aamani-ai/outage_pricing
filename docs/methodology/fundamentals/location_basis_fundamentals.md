...
*Audience: senior team. Last reviewed: 2026-06-18. Reads naturally after [`per_customer_pricing_fundamentals.md`](per_customer_pricing_fundamentals.md). See the deeper reference at [`../location_basis_methodology.md`](../location_basis_methodology.md).*
...
- The base it composes on: [`per_customer_pricing_fundamentals.md`](per_customer_pricing_fundamentals.md)
