...
- [Filtration Methodology](filtration_methodology.md) — uses `n_events_total`, `observation_years`, `n_per_year` as gate inputs
- [Pricing Methodology](pricing_methodology.md) — consumes `n_per_year` and the duration distribution
