...
- [Trigger Source Implications](../plan/trigger_source_implications.md) — earlier internal notes on Ting / PoUS / utility OMS as trigger candidates
