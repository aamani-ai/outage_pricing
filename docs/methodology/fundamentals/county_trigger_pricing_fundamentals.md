...
5. **All EAGLE-I caveats inherit.** Anything that biases the event catalog (gap-merge choice, sub-15-min invisibility, modeled MCC) biases v0 pricing. See [`eagle_i_data_fundamentals.md`](eagle_i_data_fundamentals.md) and [`event_catalog_fundamentals.md`](event_catalog_fundamentals.md).
