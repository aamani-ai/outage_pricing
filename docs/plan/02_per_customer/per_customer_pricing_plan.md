...
2. **[Customer-impact modifier proposal](../cross_cutting/outage_baseline_adjustment_framework.md#customer-impact-modifier).**
...
2. **Shadow before substitute.** The first dashboard surface is a side-by-side
   ...
   activation rules from the [modifier lifecycle](../cross_cutting/outage_baseline_adjustment_framework.md#modifier-lifecycle).
...
Artifacts:
- Notebook: [`notebooks/02_per_customer/per_customer_rate_phase1.ipynb`](../../../notebooks/02_per_customer/per_customer_rate_phase1.ipynb)
...
- [Pricing methodology](../../methodology/cross_cutting/pricing_methodology.md) — Phase 1 evidence section added.
...
- [Adjustment framework](../cross_cutting/outage_baseline_adjustment_framework.md): update
  `customer_impact_modifier` status from `gate_only` to `shadow`.
- [Pricing methodology](../../methodology/cross_cutting/pricing_methodology.md): add a Phase 2
...
- [Adjustment framework](../cross_cutting/outage_baseline_adjustment_framework.md): customer_impact_modifier moved from `gate_only` to `shadow`.
- [Pricing methodology](../../methodology/cross_cutting/pricing_methodology.md): Phase 2 evidence section added.
...
- The bias-correction modifier lifecycle is therefore refined: the
  ...
  [the refinement in the adjustment framework](../cross_cutting/outage_baseline_adjustment_framework.md#activation-pattern-by-category-refined-2026-05-30).
...
- **Portfolio aggregation (v1).** A per-customer rate is the natural unit
  ...
  feeds both. See [Portfolio Risk Engine Plan](../05_forward_regime/portfolio_risk_engine_plan.md).
- **Trigger-source bridge (Path B).** The shadow column's schema already
  ...
  [Trigger Source Implications](../cross_cutting/trigger_source_implications.md).
- **Forward-looking modifiers.** Climate, grid-condition, and hazard
  ...
  off by 30-100×. See [Forward-Looking Modeling Plan](../05_forward_regime/forward_looking_modeling_plan.md).
- **Vendor-data shrinkage.** If PowerOutage.US (or any future per-outage
  ...
  [`outage_baseline_adjustment_framework.md`](../cross_cutting/outage_baseline_adjustment_framework.md#classification-of-current-modifiers).
...
- [Customer-impact modifier proposal](../cross_cutting/outage_baseline_adjustment_framework.md#customer-impact-modifier)
  in the adjustment framework
- [Customer-impact modifier slot](../05_forward_regime/forward_looking_modeling_plan.md#customer-impact-modifier-optional-challenger)
  in the forward-looking plan
- [Trigger Source Implications](../cross_cutting/trigger_source_implications.md) — the
  Path B architecture
...
- [Pricing Methodology §v0 prices on a county trigger but quotes per customer](../../methodology/cross_cutting/pricing_methodology.md#v0-prices-on-a-county-trigger-but-quotes-per-customer-the-gap)
- [Per-Customer View — End-to-End Walkthrough](../../methodology/02_per_customer/per_customer_view_walkthrough.md) — the nuance-by-nuance pedagogical reference
...
`notebooks/02_per_customer/per_customer_rate_phase1.ipynb`. No code change to `price_engine/`
