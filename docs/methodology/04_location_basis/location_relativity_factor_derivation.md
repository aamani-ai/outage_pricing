...
- **Read alongside:** [Location Basis Methodology](location_basis_methodology.md), [Per-Customer Pricing Fundamentals](../02_per_customer/per_customer_pricing_fundamentals.md), and the location feature workstream [`docs/extra/location_features/`](../../extra/location_features/).
