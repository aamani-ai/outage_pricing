...
4. **County is the only spatial unit.** No premise, no ZIP, no circuit, no substation. A county is much larger than a typical insured site, so county-level outage data has **basis risk** at the individual-premise level. *(This is the gap our per-customer adjustment closes — see [`per_customer_view_walkthrough.md`](../02_per_customer/per_customer_view_walkthrough.md).)*
...
- Per-customer rate methodology: [`per_customer_view_walkthrough.md`](../02_per_customer/per_customer_view_walkthrough.md)
