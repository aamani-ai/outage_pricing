...
> **⚠ Downstream / gated (2026-06-22).** This is the **forecast-layer price-move** concept (how a
> regime would move λ) — it sits AFTER the current deliverable, and it's premised on the superseded
> 7-shape categories. Current Step-3 work is just deriving the **regime** itself on the masked
> series; the forecast + adjustment layers come later. See
